...
import { Estudiantes } from "../hooks/Conexionsw";
...
const ListarEstudianteView = () => {
  ...
  if (!llamada) {
    const datos = Estudiantes().then((data) => {
      console.log(data);
  ...
  return (
    <div className="container" style={{ height: "1460px", width: "2600px" }}>
      <div className="row d-flex justify-content-center">
        <h1 className="font-weight-bold mx-3 "> LISTA DE ESTUDIANTES </h1>
        <img
          src="https://img.icons8.com/ios/100/d41d6d/student-female.png"
          width={"50"}
          height={"65"}
        ></img>
      </div>
...
export default ListarEstudianteView;